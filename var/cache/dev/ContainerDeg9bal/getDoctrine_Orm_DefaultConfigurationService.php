...
$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\src\\Resources\\config\\doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'\\src\\Application\\Sonata\\UserBundle\\Resources\\config\\doctrine') => 'App\\Application\\Sonata\\UserBundle\\Entity'));
$b->setGlobalBasename('mapping');

$a->addDriver($b, 'Sonata\\UserBundle\\Entity');
$a->addDriver($b, 'App\\Application\\Sonata\\UserBundle\\Entity');
...
$instance->setEntityNamespaces(array('SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'App\\Application\\Sonata\\UserBundle\\Entity', 'App' => 'App\\Entity'));
...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'App\\Repository\\SlideRepository' => array('privates', 'App\\Repository\\SlideRepository', 'getSlideRepositoryService.php', true),
))));
