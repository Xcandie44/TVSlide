...
// Returns the public 'admin.building' autowired service.
...
$this->factories['admin.building'] = function () {
    $instance = new \App\Admin\BuildingAdmin('admin.building', 'App\\Entity\\Building', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Здание');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.building.template_registry'] ?? $this->load('getAdmin_Building_TemplateRegistryService.php')));
...
return $this->factories['admin.building']();
