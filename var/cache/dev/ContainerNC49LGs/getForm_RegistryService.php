...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'FOS\\UserBundle\\Form\\Type\\GroupFormType' => array('privates', 'fos_user.group.form.type', 'getFosUser_Group_Form_TypeService.php', true),
    ...
    'Sonata\\UserBundle\\Form\\Type\\RolesMatrixType' => array('services', 'sonata.user.form.roles_matrix_type', 'getSonata_User_Form_RolesMatrixTypeService.php', true),
    'Sonata\\UserBundle\\Form\\Type\\SecurityRolesType' => array('services', 'sonata.user.form.type.security_roles', 'getSonata_User_Form_Type_SecurityRolesService.php', true),
    'Sonata\\UserBundle\\Form\\Type\\UserGenderListType' => array('privates', 'sonata.user.form.gender_list', 'getSonata_User_Form_GenderListService.php', true),
