...
// Returns the public 'sonata.user.admin.group' service.
...
$this->factories['sonata.user.admin.group'] = function () {
    $instance = new \Sonata\UserBundle\Admin\Entity\GroupAdmin('sonata.user.admin.group', 'App\\Application\\Sonata\\UserBundle\\Entity\\Group', 'SonataAdminBundle:CRUD');
    ...
    $instance->setTemplateRegistry(($this->services['sonata.user.admin.group.template_registry'] ?? $this->load('getSonata_User_Admin_Group_TemplateRegistryService.php')));
...
return $this->factories['sonata.user.admin.group']();
