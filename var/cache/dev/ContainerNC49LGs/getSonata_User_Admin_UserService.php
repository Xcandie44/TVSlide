...
// Returns the public 'sonata.user.admin.user' service.
...
$this->factories['sonata.user.admin.user'] = function () {
    $instance = new \Sonata\UserBundle\Admin\Entity\UserAdmin('sonata.user.admin.user', 'App\\Application\\Sonata\\UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');

    $instance->setUserManager(($this->services['fos_user.user_manager'] ?? $this->load('getFosUser_UserManagerService.php')));
    ...
    $instance->setTemplateRegistry(($this->services['sonata.user.admin.user.template_registry'] ?? $this->load('getSonata_User_Admin_User_TemplateRegistryService.php')));
...
return $this->factories['sonata.user.admin.user']();
